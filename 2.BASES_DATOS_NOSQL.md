...
- Para datos que siguen el modelo relacional son mejores los SGBDR. // La lógica de la relación la realiza la aplicación
...
```
// systemctl permite enable y disable(arrancando el ordenador), service no.

### Servidor y cliente 

- **mongod**: servidor // d de diamond
- **mongo**: cliente
